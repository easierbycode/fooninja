...
var _prefab = __webpack_require__(0);
...
var _textPrefab = __webpack_require__(1);
...
var _superEventEmitter = __webpack_require__(32);
...
var _bootstrapState = __webpack_require__(27);

var _loadingState = __webpack_require__(29);

var _loginState = __webpack_require__(37);

var _levelState = __webpack_require__(28);

var _storeState = __webpack_require__(30);

var _titleState = __webpack_require__(31);
...
var StateManager = exports.StateManager = function () {
    ...
    _createClass(StateManager, [{
        ...
        value: function setupStates() {
            ...
            this.game.state.add('LoginState', _loginState.LoginState);
...
var _bomb = __webpack_require__(15);

var _spawner = __webpack_require__(4);
...
var _cuttable = __webpack_require__(3);
...
var _fruit = __webpack_require__(18);
...
var _specialFruit = __webpack_require__(24);
...
var _bombSpawner = __webpack_require__(14);

var _cut = __webpack_require__(16);

var _fruitSpawner = __webpack_require__(17);

var _leaderboard = __webpack_require__(38);

var _lives = __webpack_require__(19);
...
var _specialFruitSpawner = __webpack_require__(23);

var _jsonLevelState = __webpack_require__(5);
...
var LevelState = exports.LevelState = function (_JSONLevelState) {
    ...
    function LevelState() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LevelState.__proto__ || Object.getPrototypeOf(LevelState)).call.apply(_ref, [this].concat(args))), _this), _this.CUT_STYLE = {
            ...
            leaderboard: _leaderboard.Leaderboard.prototype.constructor
    ...
    _createClass(LevelState, [{
        ...
        value: function game_over() {
            ...
            this.game.global.database.child('players').child(auth_data.uid).set({
        ...
        value: function show_leaderboard() {
...
var _upgradeItem = __webpack_require__(26);
...
var _startStateItem = __webpack_require__(25);
...
var _game2 = __webpack_require__(6);
...
var Button = exports.Button = function (_Phaser$Button) {
    _inherits(Button, _Phaser$Button);

    function Button(game_state, name, position, properties) {
        _classCallCheck(this, Button);

        var _this = _possibleConstructorReturn(this, (Button.__proto__ || Object.getPrototypeOf(Button)).call(this, game_state.game, position.x, position.y, properties.texture, game_state[properties.callback], game_state));
...
var PlayerInput = exports.PlayerInput = function (_Prefab) {
    _inherits(PlayerInput, _Prefab);

    function PlayerInput(game_state, name, position, properties) {
        _classCallCheck(this, PlayerInput);

        var _this = _possibleConstructorReturn(this, (PlayerInput.__proto__ || Object.getPrototypeOf(PlayerInput)).call(this, game_state, name, position, properties));

        _this.inputEnabled = true;

        _this.events.onInputDown.add(_this.select, _this);

        _this.player_input = new _textPrefab.TextPrefab(_this.game_state, _this.name + '_input', _this.position, properties.text_properties);

        _this.game_state.groups.hud.add(_this.player_input);
        return _this;
    }
...
var _playerInput = __webpack_require__(36);
...
var LoginState = exports.LoginState = function (_JSONLevelState) {
    _inherits(LoginState, _JSONLevelState);
    ...
    function LoginState() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LoginState.__proto__ || Object.getPrototypeOf(LoginState)).call.apply(_ref, [this].concat(args))), _this), _this.prefab_classes = {
            background: _prefab.Prefab.prototype.constructor,
            title: _textPrefab.TextPrefab.prototype.constructor,
            player_input: _playerInput.PlayerInput.prototype.constructor,
            button: _button.Button.prototype.constructor
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(LoginState, [{
        ...
        key: 'save_player_input',
        value: function save_player_input(char) {
            this.current_player_input.text += char;
        }
    }, {
        key: 'attempt_login',
        value: function attempt_login() {
            var _this2 = this;

            this.email = this.prefabs.email_input.player_input.text;
            this.password = this.prefabs.password_input.player_input.text;

            this.game.global.auth.signInWithEmailAndPassword(this.email, this.password).catch(function (err) {
                if (err.code === 'auth/user-not-found') {
                    _this2.game.global.auth.createUserWithEmailAndPassword(_this2.email, _this2.password).then(function (user_data) {
                        _this2.attempt_login();
                    });
                }
            }).then(function (auth_data) {
                _this2.on_login(auth_data);
            });
        }
    }, {
        key: 'on_login',
        value: function on_login(auth_data) {
            this.game.global.database.child('players').child(auth_data.uid).once('value', this.save_player_data.bind(this));
        }
    }, {
        key: 'save_player_data',
        value: function save_player_data(snapshot) {
            var _this3 = this;
            ...
            if (player_data) {
                ...
                this.game.global.database.child('players').child(snapshot.key).set({
                    name: this.game.player_name,
                    money: this.game.money,
                    max_score: this.game.max_score

                }).then(function () {
                    _this3.game.state.start('Bootstrap', true, false, 'assets/levels/title-screen.json', 'TitleState');
                });
            }
        }
    }]);
...
var Leaderboard = exports.Leaderboard = function (_Prefab) {
    _inherits(Leaderboard, _Prefab);

    function Leaderboard(game_state, name, position, properties) {
        _classCallCheck(this, Leaderboard);

        var _this = _possibleConstructorReturn(this, (Leaderboard.__proto__ || Object.getPrototypeOf(Leaderboard)).call(this, game_state, name, position, properties));

        _this.scores = [];


        _this.number_of_scores = properties.number_of_scores;
        _this.scores_spacing = properties.scores_spacing;
        _this.text_properties = properties.text_properties;
        return _this;
    }
    ...
    _createClass(Leaderboard, [{
        key: 'show_leaderboard',
        value: function show_leaderboard() {
            this.game.database.child('players').orderByChild('max_score').limitToLast(this.number_of_scores).on('child_added', this.update_leaderboard.bind(this));

            this.game_state.game.input.keyboard.addCallbacks(this, this.process_keyboard);
        }
    }, {
        key: 'update_leaderboard',
        value: function update_leaderboard(snapshot) {
            ...
            score = new _textPrefab.TextPrefab(this.game_state, 'score' + this.scores.length, score_position, this.text_properties);
        ...
        value: function process_keyboard() {
